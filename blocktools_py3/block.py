...
class txOutput:
    ...
    def decodeScriptPubkey(self, data):
        ...
        try:
            ...
            keylen = op_idx
            op_codeTail = OPCODE_NAMES[
                int(hexstr[2 + keylen * 2 : 2 + keylen * 2 + 2], 16)
            ]
            print(
                " \tPubkey OP_CODE:\t "
        ...
        if op_code1 == "OP_DUP":  # P2PKHA pay to pubkey hash mode
            ...
            op_codeTail2nd = OPCODE_NAMES[
                int(hexstr[6 + keylen * 2 : 6 + keylen * 2 + 2], 16)
            ]
            op_codeTailLast = OPCODE_NAMES[
                int(hexstr[6 + keylen * 2 + 2 : 6 + keylen * 2 + 4], 16)
            ]
            print(
                " \tPubkey OP_CODE:\t "
                + op_code1
            ...
            op_codeTail = OPCODE_NAMES[
                int(hexstr[4 + keylen * 2 : 4 + keylen * 2 + 2], 16)
            ]
            print(
                " \tPubkey OP_CODE:\t "
                + op_code1
